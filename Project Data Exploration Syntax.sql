...
Select Location, date, Population, total_cases,  (total_cases*100/population) as PercentPopulationInfected
From CovidDeaths
order by 1,2
;
...
Select *, (RollingPeopleVaccinated*100/Population) RPVPercent
From PopvsVac
;
...
Join CovidVaccinations vac
	...
	and dea.date = vac.date
;
Select *, (RollingPeopleVaccinated*100/Population) as RPVPercent
